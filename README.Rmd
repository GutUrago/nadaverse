...
Welcome to `nadaverse`, the essential R package for researchers, policy analysts, and data enthusiasts seeking streamlined, programmatic access to vast collections of global microdata.

Many national and international organizations—including the World Bank, FAO, and ILO—use the National Data Archive (NADA) software to manage and disseminate their survey and census data. While these catalogs are rich sources of information, interacting with them often requires tedious manual browsing or complex API construction.
...
- **Motivation:** Stop clicking, start coding. Unlock the world's microdata resources faster than ever before.
